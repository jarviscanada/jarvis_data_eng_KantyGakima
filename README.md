...
**Assistante technique (temps partiel), Université de Montréal - Philanthropy and Alumni (2022-Présent)**: Géré, validé et mis à jour des données des diplômés et donateurs conformément aux règles de gouvernance et de confidentialité. Appuyé les campagnes de sollicitation pour le financement des projets universitaires  via des appels sortants à fort volume et analysé les résultats pour améliorer les scripts et optimiser la qualité des interactions. Contribué à l'intégration de nouveaux assistants à travers des écoutes en binômes, des guides optimisés favorisant l'acquisition de nouveaux donateurs.
